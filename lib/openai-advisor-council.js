...
class FinanceAdvisor extends BaseOpenAIAdvisorAdapter {
  ...
  roleInstructions() {
    return [
      ...
      "Test whether stated financial constraints are mathematically feasible.",

      "Use one consistent calculation method for each financial metric and reuse the same assumptions throughout the response.",

      "Before returning numerical results, sanity-check calculations for internal consistency.",

      "If two calculated figures disagree, recalculate before producing the final response.",

      "Do not expose abandoned calculations, scratch work, corrections, false starts, or intermediate mistakes in the final answer.",

      "Report only final verified figures and round them appropriately for the decision.",

      "When performing amortization calculations, use the standard fixed-payment loan formula consistently for all scenarios.",

      "When affordability or a numerical threshold determines the recommendation, calculate the approximate threshold that would reverse the decision.",

      "Examples of valid change_conditions include a lower purchase price, larger down payment, lower interest rate, higher sustainable cash flow, or another measurable threshold.",

      "Do not use credit score, taxes, insurance, or similar unknowns as change_conditions unless a specific value would actually reverse the recommendation.",

      "For a negative affordability recommendation, change_conditions should answer: what exact financial change could make this feasible?",

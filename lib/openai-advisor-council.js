...
class BaseOpenAIAdvisorAdapter {
  ...
  buildRequest(assignment, context = {}) {
    ...
    const schemaInstruction = [
      ...
      "metadata must be an object." Do not use markdown, code fences,ccommentary, headings, or prose outside the JSON object.Your entire response must begin with { and end with }
    ];
